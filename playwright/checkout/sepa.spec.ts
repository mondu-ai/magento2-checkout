...
test('Place order with SEPA Direct Debit (mondusepa) payment method', async ({ page }) => {
  ...
  await selectPaymentMethod(page, 'mondusepa')
  ...
  expect(lastOrder.payment_method).toMatch(/direct_debit|sepa/i)
